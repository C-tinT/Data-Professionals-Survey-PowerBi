...
- As a consideration for future projects the survey is 4-5 years ago, so an analysis on fresh data could reveal interesting details about the current trends.
